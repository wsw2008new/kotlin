...
abstract class JavaAbstractUElement : UElement {
    init {
        val psiElement = (this as? PsiElementBacked)?.psi
        // Do not cache elements without parent (they might be generated by generateWithoutParent)
        if (parent != null) {
            psiElement?.putUserData(CACHED_UELEMENT_KEY, WeakReference(this as UElement))
        }
    }
