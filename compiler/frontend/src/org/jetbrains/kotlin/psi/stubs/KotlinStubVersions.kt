...
object KotlinStubVersions {
    ...
    // Source stub version should be increased
    //      when changes are made to the parser that can potentially change the psi structure of kotlin source code.
    ...
    // Binary stub version should be increased when changes are made to the core stub building code (org.jetbrains.kotlin.idea.decompiler.stubBuilder).
    // Increasing this version will lead to reindexing of all binary files that are potentially kotlin binaries (including all class files).
    const val BINARY_STUB_VERSION = 1
    ...
    // JS stub version should be increased if changes are made to builtin stub building subsystem (org.jetbrains.kotlin.idea.decompiler.js)
